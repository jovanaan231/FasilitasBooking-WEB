            ...
            <?php if (!empty($kategori)):
                foreach ($kategori as $key => $p) {
                  ...
                  echo '<tr>';
                    ...
                    <a class="btn btn-danger btn-xs" href="'.base_url('data_kategori_pinjam/hapus/'.$p->kategori_id).'">Hapus</a>
                    </td>';
                  echo '</tr>';
                } endif; ?>
          </tbody>
...
<div id="modal_kategori" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="" action="<?php echo base_url('data_kategori_pinjam/simpan')?>" method="post">
